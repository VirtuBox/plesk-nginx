...
b1g-dev libpcre3-dev libgd-dev libssl-dev libxslt1-dev libxml2-dev libgeoip-dev libgoogle-perftools-dev libperl-devapt-get update && apt-get install -y git build-essential libtool automake autoconf zlib1g-dev \
